...
namespace DutchTreat.Migrations
{
    ...
    [Migration("20220214192502_Identity")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DutchTreat.Controllers.Data.Entities.StoreUser", b =>
                {
            ...
            modelBuilder.Entity("DutchTreat.Data.Entities.Order", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            OrderDate = new DateTime(2022, 2, 14, 19, 25, 1, 7, DateTimeKind.Utc).AddTicks(4100),
                            OrderNumber = "12345"
                        });
                });
            ...
            modelBuilder.Entity("DutchTreat.Data.Entities.Order", b =>
                {
                    b.HasOne("DutchTreat.Controllers.Data.Entities.StoreUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("DutchTreat.Controllers.Data.Entities.StoreUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
